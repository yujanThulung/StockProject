...
const History = () => {
  const { historicalData, ticker, fetchHistoricalData, loading, error } = usePricePredictionStore();
  ...
  if (!historicalData || historicalData.length === 0)
    return (
      <EmptyState 
        ...
        description="We couldn't find any historical price data for this symbol." 
      />
    );
        ...
        <table className="w-full divide-y divide-gray-200 table-auto">
          <thead className="bg-gray-800 sticky top-0 z-10">
            <tr>
              ...
              <th className="px-4 py-2 text-left text-xs font-medium text-white uppercase">Open</th>
              <th className="px-4 py-2 text-left text-xs font-medium text-white uppercase">High</th>
              <th className="px-4 py-2 text-left text-xs font-medium text-white uppercase">Low</th>
              <th className="px-4 py-2 text-left text-xs font-medium text-white uppercase">Close</th>
              <th className="px-4 py-2 text-left text-xs font-medium text-white uppercase">Volume</th>
            </tr>
          </thead>
